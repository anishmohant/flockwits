class PhraseOMatic{
	public static void main (String args [])
	{
		...
		String phrase = wordListOne[rand1]+ " "+wordListTwo[rand2]+" "+wordListThree[rand3]+" on a "+ wordListTwo[rand2+1]+" with two "+wordListThree[rand3+1]+"s.";   // improvised.
